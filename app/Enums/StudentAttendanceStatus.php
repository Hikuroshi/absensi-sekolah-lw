...
enum StudentAttendanceStatus: string
{
    ...
    case BELUM_ABSEN_MASUK = 'belum absen masuk';
    case BELUM_ABSEN_KELUAR = 'belum absen keluar';
    ...
    public function label(): string
    {
        return match ($this) {
            ...
            self::BELUM_ABSEN_MASUK => 'Belum Absen Masuk',
            self::BELUM_ABSEN_KELUAR => 'Belum Absen Keluar',

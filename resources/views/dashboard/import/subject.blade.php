<x-layout.app :$title>
    ...
    <div class="glass-card rounded-xl p-6 text-center">
        ...
        <form
            x-data
            x-ref="form"
            action="{{ route('import-subject.store') }}"
            method="POST"
        ...
        >
            ...
            <div class="flex flex-col gap-3 text-center sm:flex-row sm:items-center sm:justify-center sm:gap-6">
                <a class="flex w-full items-center justify-center whitespace-nowrap rounded-lg bg-purple-600 px-4 py-3 text-sm font-medium text-white hover:bg-purple-700 sm:w-auto" href="{{ asset('import-template/subject-template.xlsx') }}" download>
